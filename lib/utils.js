...
/**
 * Normalize a priority value into the object Jira expects.
 * Jira accepts a priority as { name: "High" } or { id: "2" }. Accepts a friendly
 * string (numeric string or number -> id, otherwise name), or an
 * already-shaped object (passed through). Returns undefined for empty input so
 * callers can skip setting the field.
 * @param {string|number|Object|null|undefined} priority
 * @returns {{name: string}|{id: string}|Object|undefined}
 */
